        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutMapLoc = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommendID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CommendUserName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CommendContent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CommendTitle = table.Column<int>(type: "int", nullable: false),
